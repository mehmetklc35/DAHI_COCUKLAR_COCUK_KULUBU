...
const Team = () => {
  const teamMembers = [
    {
      ...
      image:
        "https://st3.depositphotos.com/1075946/15893/i/450/depositphotos_158939218-stock-photo-l-woman-relaxing-at-home.jpg",
    },
    {
      id: 2,
      name: "Ayşe...",
      role: "Bilim Atölyesi Lideri",
      image:
        "https://st3.depositphotos.com/1075946/15893/i/450/depositphotos_158939218-stock-photo-l-woman-relaxing-at-home.jpg",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-blue-100 py-16 px-6">
      <h1
        className="text-6xl font-extrabold text-indigo-700 mb-12 text-center"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-7xl mx-auto">
        {teamMembers.map((member) => (
          <div
            key={member.id}
            className="relative bg-white rounded-3xl shadow-2xl overflow-hidden transition-transform duration-500 hover:scale-105 hover:shadow-3xl"
          >
            ...
            <div className="p-6 text-center">
              <h2
                className="text-3xl font-extrabold text-indigo-600 mb-2 transition-colors duration-300 hover:text-pink-600"
                style={{ fontFamily: "Comic Sans MS, cursive" }}
              >
                {member.name}
              </h2>
