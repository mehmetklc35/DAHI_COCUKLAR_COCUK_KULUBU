...
const Team = () => {
  const teamMembers = [
    { id: 1, name: 'Meral...', role: 'Eğitim Koordinatörü', image: '/images/ayse.jpg' },
    { id: 2, name: 'Ayşe...', role: 'Bilim Atölyesi Lideri', image: '/images/mehmet.jpg' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {teamMembers.map((member) => (
          <div key={member.id} className="bg-white p-6 rounded-xl shadow-lg hover:scale-105 transition-transform">
            <img src={member.image} alt={member.name} className="w-full h-40 object-cover rounded-t-xl mb-4" />
